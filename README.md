...
- `llm_anachronism_proposal.py`: Given a prompt with a historical condition, an LLM proposes potential anachronisms in the generated images, as well as identification questions for a VLM model.
